...
CREATE TABLE IF NOT EXISTS core.model_caps (
    ...
    -- Composite key: the same base model is hosted by more than one provider
...
INSERT INTO core.model_caps
    (model_id, provider, context_cap_tokens, input_nanos_per_mtok, cached_input_nanos_per_mtok, output_nanos_per_mtok, created_at_ms, updated_at_ms)
VALUES
    ('claude-opus-4-8',                            'anthropic', 1000000,  5000000000,  500000000, 25000000000, 1745884800000, 1745884800000),
    ('claude-sonnet-4-6',                          'anthropic',  256000,  3000000000,  300000000, 15000000000, 1745884800000, 1745884800000),
    ('claude-haiku-4-5-20251001',                  'anthropic',  256000,  1000000000,  100000000,  5000000000, 1745884800000, 1745884800000),
    ('gpt-5.5',                                    'openai',     256000,           0,          0,           0, 1745884800000, 1745884800000),
    ('gpt-5.4',                                    'openai',     256000,           0,          0,           0, 1745884800000, 1745884800000),
    ('kimi-k2.6',                                  'moonshot',   256000,           0,          0,           0, 1745884800000, 1745884800000),
    ('accounts/fireworks/models/kimi-k2.6',        'fireworks',  256000,   950000000,  100000000,  4000000000, 1745884800000, 1745884800000),
    ('accounts/fireworks/models/deepseek-v4-pro',  'fireworks',  256000,  1740000000,  140000000,  3480000000, 1745884800000, 1745884800000),
    ('minimax-m3',                                 'minimax',   1048576,   600000000,   60000000,  2400000000, 1745884800000, 1745884800000),
    ('claude-opus-4-8',                            'pioneer',   1000000,  5500000000,  550000000, 27500000000, 1745884800000, 1745884800000),
    ('claude-sonnet-4-6',                          'pioneer',   1000000,  3300000000,  330000000, 16500000000, 1745884800000, 1745884800000),
    ('claude-haiku-4-5',                           'pioneer',    200000,  1100000000,  110000000,  5500000000, 1745884800000, 1745884800000),
    ('moonshotai/Kimi-K2.6',                       'pioneer',    262000,   950000000,   95000000,  4000000000, 1745884800000, 1745884800000)
