...
pub const request_correlation_sql = @embedFile("005_request_correlation.sql");
...
pub const run_snapshot_version_sql = @embedFile("010_run_snapshot_version.sql");
pub const profile_linkage_audit_sql = @embedFile("011_profile_linkage_audit.sql");
pub const trace_context_sql = @embedFile("012_trace_context.sql");
