...
function printHelp(stdout, _ui, opts = {}) {
  ...
  helpRow(stdout, "login [--timeout-sec N] [--poll-ms N] [--no-open]", "Authenticate via browser");
  helpRow(stdout, "logout", "Clear stored credentials");
  helpRow(stdout, "workspace add [<name>]", "Create a new workspace");
  helpRow(stdout, "workspace list", "List workspaces");
  helpRow(stdout, "workspace use <workspace_id>", "Set the active workspace");
  helpRow(stdout, "workspace show [--workspace-id ID]", "Show workspace details");
  helpRow(stdout, "workspace credentials", "Open the credential vault");
  helpRow(stdout, "workspace delete <workspace_id>", "Delete a workspace (irreversible)");
  helpRow(stdout, "doctor", "Diagnose CLI configuration and connectivity");
  writeLine(stdout);
