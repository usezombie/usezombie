...
export default function ZombieHandIcon({ size = 20, ...rest }: Props) {
  return (
    ...
    >
      ...
      />
      {/* Knuckle details */}
      <circle cx="25" cy="28" r="1" fill="#2d5a23" opacity="0.4" />
      <circle cx="30" cy="27" r="1" fill="#2d5a23" opacity="0.4" />
      <circle cx="36" cy="28" r="1" fill="#2d5a23" opacity="0.4" />
      {/* Stitches on wrist */}
      <line x1="27" y1="46" x2="27" y2="50" stroke="#2d5a23" strokeWidth="0.8" opacity="0.5" />
      <line x1="32" y1="45" x2="32" y2="49" stroke="#2d5a23" strokeWidth="0.8" opacity="0.5" />
      <line x1="37" y1="46" x2="37" y2="50" stroke="#2d5a23" strokeWidth="0.8" opacity="0.5" />
    </svg>
  );
}
