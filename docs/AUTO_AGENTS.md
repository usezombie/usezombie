...
| 5 | **autovaultsaver** | hardened server | server name + credentials | 1Password item created (`zombie-prod-server-{name}`) |
...
Server naming: alphabetical animals (`zombie-prod-server-ant`, `zombie-prod-server-bird`, ...).
