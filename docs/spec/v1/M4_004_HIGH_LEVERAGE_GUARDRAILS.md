...
**Dimensions:**
- 1.1 IN_PROGRESS D2 Allocation normalization (per-run allocator model + reduced manual free churn; run-claim arena normalization + limiter key lookup stack-fast-path + key-churn leak stress coverage landed)
