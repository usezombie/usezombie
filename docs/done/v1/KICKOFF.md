...
5) docs/M2_002_PLAYBOOK_PRIMING_INFRA.md + docs/M3_001_PLAYBOOK_DEPLOY_DEV.md + docs/M3_002_PLAYBOOK_DEPLOY_PROD.md
...
### Config
- [ ] `.env.example` — all env vars from M2/M3 deployment playbooks with placeholder values.
