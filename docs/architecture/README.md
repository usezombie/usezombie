...
| [`ship_reflection.md`](./ship_reflection.md) | §14 post-launch reflection appendix (folded from M50). Pre-launch skeleton; populated with real evidence — launch date, first external install, deferral status — once v2 ships. |
