...
// Generic webhook signature codes — shared by slack_signature, webhook_sig,
// and svix_signature. Named without provider prefix because the same code
// fires for every HMAC-style webhook failure (M28_001 consolidation).
